...
export default function Error() {
    return (
        <>
            ...
            >
                <path
                    d="M1031 23.4141H1027V414.814H1031V23.4141Z"
                    fill="#00694B"
                />
                ...
                <path
                    d="M769 167.512H765V759.317H769V167.512Z"
                    fill="#12AB52"
                />
                <path
                    d="M1031 27.3086H1027V753.476H1031V27.3086Z"
                    fill="#12AB52"
                />
                <defs>
            ...
            <div className="max-600:bg-[#00694B] max-600:h-[89vh] max-600:left-0 max-600:w-[100vw] max-600:p-[5vw] w-[35vw] left-[5vw] relative max-lg:w-[90vw]">
                ...
                <div className="max-600:w-[85vw] max-600:text-[#FFFFFF] font-medium font-[Poppins] text-[20px]">
                    We’re sorry, the page you requested couldn't be found, Go
                    back to home page.
                </div>
                <Button
                    color={"success"}
