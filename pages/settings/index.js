...
const Settings = () => {
  ...
  const openNotification = (placement) => {
    const description = (
      <div>
        <p>Verify your Email to get access to all the features of SaveMyForm</p>
        <Button
          ...
          <div className="flex flex-col gap-8 shadow-[0_4px_4px_0px_fbeefc] rounded-lg p-8 bg-[#ffffff]">
            ...
            {!passwordTab && (
              <div>
                <Input
                  placeholder="Name"
                  className={`${passwordTab ? "hidden" : "block"} rounded-lg border-solid border-2 border-[#01684a]`}
                  onChange={(e) => {
            ...
            <div className="flex flex-row gap-2">
              <button
                ...
                onClick={() => {
                  {
                    passwordTab ? validatePasswords() : updateUser();
                  }
                }}
              >
                Save
