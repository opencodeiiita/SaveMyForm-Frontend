  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 h-screen overflow-auto">
      <div className="hidden sm:block h-full">
        <div className="bg-[#FFFEFE] flex flex-col justify-center items-center h-full ">
          <div className="py-5 object-contain flex overflow-auto">
            <svg width="187" height="200" viewBox="0 0 87 67" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <div className="text-5xl font-inter text-[#001E2B] font-semibold">SaveMyForm</div>
        </div>
      </div>
      ...
      <div className="bg-[#001E2B] flex flex-col justify-center items-center">
        ...
        <div className="text-[#FFFFFF] text-4xl p-5 text-center font-semibold ">Verify your account</div>
        <div className="w-2/3 p-5">
          <div className="text-[#FFFFFF] text-1xl opacity-80 text-center">
            A verification link has been sent to your email: <u>example@domain.com</u>. Please verify to complete your
            registration.
          </div>
        </div>
        <button className="bg-[#12AB52] p-2 rounded-md text-[#FFFFFF] font-inter">Login and Continue</button>
      </div>
    </div>
  );
}
