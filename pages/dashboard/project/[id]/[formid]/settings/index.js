...
export default function NewForm() {
  ...
  const hasFileField = useMemo(
    () =>
      fields.some((field) => field.type === "image" || field.type === "file"),
    [fields]
  );
      ...
      <>
            ...
            >
              <div className="flex flex-col gap-8 shadow-[0_4px_4px_0px_#00000040] rounded-lg p-8 bg-[#ffffff]">
                ...
                <div className="flex flex-row gap-2">
                  <Checkbox
                    value={hasRecaptcha}
                    onChange={(e) => setHasRecaptcha(e.target.checked)}
                  />
        ...
        >
          ...
          <p className="leading-5 ">
            We need your password to verify that you are the owner of this form.
          </p>
