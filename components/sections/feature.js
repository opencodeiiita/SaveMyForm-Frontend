    ...
    <>
      <div className="relative h-[100vh] w-[100vw]">
        ...
        <div className="absolute top-0 max-600:bg-[#001E2B] flex justify-center h-[100vh] w-full">
          ...
          >
            <div className="max-600:absolute max-600:left-0 absolute flex justify-center left-[100px] top-0 w-[50%] h-[100%] max-md:justify-start max-md:ml-6">
              <div
                ref={text}
                className={`reveal-bottom ${textVisible ? "active-reveal" : ""
                  } max-[600px]:absolute leading-normal  max-600:top-[270px] max-600:w-[85vw] z-10 w-[60%] h-[60%] mt-[22vh] font-sans text-[#FFFFFF] max-xl:w-[80%]`}
              >
                <h5
                ...
                <h5 className="max-[600px]:hidden leading-normal  font-semibold text-3xl text-[#FFFFFF]">
            ...
            <div
              ref={code}
              className={`reveal-bottom  ${codeVisible ? "active-reveal" : ""
                } max-600:top-20 max-600:left-6 mt-0 absolute top-[30vh] right-[15%] z-10 h-[20vw] w-[20vw] min-w-[400px] min-h-[400px] 
                 max-xl:right-16 md:min-w-[300px] md:min-h[300px]  sm:min-w-[200px] sm:min-h[200px] max-md:right-8`}
            >
              <Image
                src={templateCode}
                alt={"templateCode"}
            ...
            <div
              ref={circle1}
              className={`reveal-bottom ${circle1Visible ? "active-reveal" : ""
            ...
            <div
              ref={circle3}
              className={`reveal-bottom ${circle3Visible ? "active-reveal" : ""
