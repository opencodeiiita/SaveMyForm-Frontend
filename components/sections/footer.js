      ...
      <div className="md:text-center sm:text-left space-y-10">
        ...
        <h2 className="text-sm font-inter ">
          <span className="text-[#FFFFFF] opacity-80">
            ...
            design and empower you to execute the roadmap.<br></br> We stay
            light on our feet and truly enjoy delivering great work.
          </span>
        </h2>
        <div className="space-y-20">
          ...
          <div className=" flex items-center justify-between ">
            ...
            <div className="text-[#FFFFFF] md:text-center sm:text-left">
              © 2022 <span className="text-[#01EC64]">SaveMyForm</span>. All
              Rights Reserved.
            </div>
