    ...
    return(
        <footer className="bg-[#061621] p-14 text-[#FFFFFF] leading-normal overflow-auto">
            ...
            <div className="space-y-20">
                <h2 className="font-inter text-base bg-white space-x-4">
                    <button className="border-2 rounded-lg bg-[#FFFFFF] border-[#12AB51]">👀 Insights</button>
                    <button className="border-2 rounded-lg bg-[#FFFFFF] border-[#12AB51]">👋 Contact</button>
                </h2>
