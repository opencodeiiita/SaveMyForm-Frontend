      ...
      <div className="md:text-center sm:text-left space-y-10">
        ...
        <h2 className="text-sm font-inter ">
          <span className="text-[#FFFFFF] opacity-80">
            We're a diverse and passionate team that takes ownership of your design and empower you to execute the
            roadmap.<br></br> We stay light on our feet and truly enjoy delivering great work.
          </span>
        </h2>
