        ...
        <footer className="bg-[#061621] p-14 text-[#FFFFFF] leading-normal overflow-auto">
            <div className="md:text-center sm:text-left space-y-10">
                ...
                <h2 className="text-sm font-inter ">
                    <span className="text-[#FFFFFF] opacity-80">
                        We're a diverse and passionate team that takes ownership
                        of your design and empower you to execute the roadmap.
                        <br></br> We stay light on our feet and truly enjoy
                        delivering great work.
                    </span>
                </h2>
                <div className="space-y-20">
                    <h2 className="font-inter text-sm bg-white space-x-4">
                        <button className="border-2 rounded-lg bg-[#FFFFFF] border-[#12AB51] p-2">
                            👀 Insights
                        </button>
                        <button className="border-2 rounded-lg bg-[#FFFFFF] border-[#12AB51] p-2">
                            👋 Contact
                    ...
                    <div className="flex-grow h-px bg-[#12AB51] opacity-25"></div>
                    ...
                    <div className=" flex items-center justify-between ">
                        ...
                        <div className="text-[#FFFFFF] md:text-center sm:text-left">
                            © 2023{" "}
                            <span className="text-[#01EC64]">SaveMyForm</span>.
                            All Rights Reserved.
                        </div>
                        <div className="flex justify-between space-x-3">
                            <svg
                                className="w-6 h-6 text-[#01EC64] fill-current"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                            >
                            ...
                            <svg
                                className="w-6 h-6 text-[#FFFFFF] fill-current"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 448 512"
                            >
