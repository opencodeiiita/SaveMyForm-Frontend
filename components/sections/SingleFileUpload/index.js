    ...
    <>
      <div className="max-600:h-[80vh] h-[100vh] relative bg-[#01EC64] max-600:bg-[#01694b]">
        ...
        <div className=" max-600:w-[90vw] max-600:top-[50vh] max-600:translate-y-[-40%] max-600:left-0 max-600:mx-8 absolute top-0 left-[40vw] inline-block w-[60vw] h-[100vh]">
          ...
          >
            <div className=" max-600:w-[60vw] max-600:text-3xl text-[#FFFFFF] max-800:text-3xl text-[52px] w-[40vw] font-bold  max-1140:text-4xl">
              Single file upload allowed!
            </div>

            <div className="max-600:mt-16 max-600:w-[80vw] max-600:text-lg max-800:text-base text-[#FFFFFF] w-[75%] font-medium  text-xl max-1140:text-lg mt-8">
