    ...
    <>
      <div className=" h-[100vh] relative max-600:bg-[#001E2B]">
        ...
        <div className=" max-600:w-[90vw] max-600:top-[50vh] max-600:translate-y-[-40%] max-600:left-0 max-600:mx-8 absolute top-0 left-[40vw] inline-block w-[60vw] h-[100vh]">
          ...
          >
            <div className=" max-600:text-2xl max-600:text-[#FFFFFF] max-800:text-3xl text-[52px] font-bold max-1140:text-4xl">
            ...
            <div className="max-600:mt-16 max-600:text-[#FFFFFF] max-600:w-[80vw] max-600:text-lg max-800:text-base text-[#116148] w-[75%] font-medium  text-xl max-1140:text-lg max-1140:mt-2">
